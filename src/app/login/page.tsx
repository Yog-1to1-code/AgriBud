...
import { Sprout, ShieldCheck, ArrowLeft, UserCircle2, Loader2 } from 'lucide-react';
          ...
          <div className="glass animate-fade-in" style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', margin: '0.5rem 0' }}>
                ...
                <span style={{ padding: '0 1rem', color: 'var(--text-muted)', fontSize: '0.85rem', fontWeight: 500 }}>OR</span>
                <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--border)' }}></div>
              </div>
              ...
              >
                {isGuestLoading ? <Loader2 className="animate-spin" size={24} color="var(--primary)" /> : <UserCircle2 size={24} color="var(--primary)" />}
